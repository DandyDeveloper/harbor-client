...
import { HarborRequest, IChart, isArrayEmpty, handleError, IImage, ILabel, IProject } from ".";

export default class HarborClient {
  private readonly params: HarborRequest;
  private readonly headers: Headers;
  constructor(params: HarborRequest, headers: Headers) {
    this.params = params;
